...
<?php /*
Template Name: Sales Style 2 (Video Sidebar Top)
*/
?>
...
//-->
        ...
        <div id="videobox3"  style="width:<?php echo $videowidth?>;height:<?php echo $videoheight?>;">
          <div id='mediaspace'>
            <center>
              Your browser does not support Flash or does not have it installed. <a href="http://www.adobe.com/products/flashplayer/" target="_blank">Click here download Flash Now</a>
            </center>
          </div>
          <script type='text/javascript'>
