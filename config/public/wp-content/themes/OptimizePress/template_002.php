...
background: #<?php echo ($squeezepagenavbarmainbggradienttopcolor) ? $squeezepagenavbarmainbggradienttopcolor : ""; ?>;
	...
	border-bottom:<?php echo ($squeezepagenavbarbottomlinethickness) ? $squeezepagenavbarbottomlinethickness : ""; ?>px solid #<?php echo ($squeezepagenavbarbottomlinecolor) ? $squeezepagenavbarbottomlinecolor : ""; ?>;
}


#access a {color:#<?php echo ($squeezepagenavbartextcolor) ? $squeezepagenavbartextcolor : ""; ?>;text-shadow:0 1px 0 #<?php echo ($squeezepagenavbartextshadow) ? $squeezepagenavbartextshadow : ""; ?>;font-weight:NORMAL OR BOLD CONDITIONAL HERE}
...
alert(msg);
    ...
    <?php $autoplay = !empty($postcustom['_optthemes_autoplay']) ? "true" :  "false"; ?>
     ...
     <style>body{font-family:<?php echo $mainbodytextfont?>;background: #e7e7e7 url(<?php echo $url?>/images/template002-bg.png);background-repeat:repeat-x;}
...
#access ul ul :hover > a {
	...
	text-shadow:0 1px 0 #<?php echo ($squeezepagenavbartextshadow) ? $squeezepagenavbartextshadow : ""; ?>;
	font-size:<?php echo ($squeezepagenavbarfontsize) ? $squeezepagenavbarfontsize : ""; ?>px;
}
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_optthemes_videoembedcode'])){
                   $videoheight = !empty($postcustom['_optthemes_videoheight']) ? stripcslashes($postcustom['_optthemes_videoheight'][0])."px" :  "370px";
                   $videowidth = !empty($postcustom['_optthemes_videowidth']) ? stripcslashes($postcustom['_optthemes_videowidth'][0])."px" :  "650px";
 ...
 <style>
 #videocontainer{width:<?php echo $videowidth?>;height:<?php echo $videoheight?>;}
...
<?php comments_template(); // Get wp-comments.php template ?>
        ...
        case "Facebook" : { ?>
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<?php echo $thesharelink; ?>" show_faces="true" send="true" width="560" font=""></fb:like>
...
<div class="fb-comments" data-href="<?php echo $thesharelink; ?>" data-num-posts="<?php echo ($postcustom['_optthemes_fbcommentnum']) ? $postcustom['_optthemes_fbcommentnum'][0] : '20'; ?>" data-width="560" publish_feed="true"></div>
</div>
