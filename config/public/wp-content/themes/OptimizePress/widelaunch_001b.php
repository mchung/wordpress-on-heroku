...
<?php /*
Template Name: Wide Sales Style 1 (Squeeze Style)
*/
?>
...
#membersnavbar{<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px;' : ""; ?><?php echo ($salesletternavbaralignment) ? 'text-align:'.stripslashes($salesletternavbaralignment).';' : ""; ?>width:1030px !important;}
...
<?php if($postcustom['_launchpage_showheader']) { ?>
    ...
    <style>
	    #launchheader{<?php echo ($header_height) ? "height:".$header_height."px" : ""; ?>;background-image:url(<?php echo $launchheader; ?>);}
	.launchheaderlogo{background-position:<?php echo $logo_align; ?> center;background-image:url(<?php echo $launchheaderlogo; ?>);<?php echo ($header_height) ? "height:".$header_height."px" : ""; ?>;width:1037px;background-repeat:no-repeat;}
...
<!--Start special video optin area-->


<div style="float:left;width:650px;padding-left:30px;">

<?php    $launchvideocontainerheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "360px";
   $launchvideocontainerwidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "640px";
?>
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_launchpage_videourl'])){
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "360px";
                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "640px";
...
<?php } ?>
    ...
    </div><!--close left side of box area-->
...
<!--close special video optin area-->
...
<?php comments_template(); // Get wp-comments.php template ?>
        ...
        case "Facebook" : { ?>
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<?php echo $thesharelink; ?>" show_faces="true" send="true" width="915" font=""></fb:like>
...
<div class="fb-comments" data-href="<?php echo $thesharelink; ?>" data-num-posts="<?php echo ($postcustom['_launchpage_fbcommentnum']) ? $postcustom['_launchpage_fbcommentnum'][0] : '20'; ?>" data-width="915" publish_feed="true"></div>
