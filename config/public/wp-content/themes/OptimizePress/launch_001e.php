...
<?php /*
Template Name: Sales Style 1 (Sales Letter w/Sidebar)
*/
?>
...
#membersnavbar{<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px' : ""; ?>;<?php echo ($salesletternavbaralignment) ? 'text-align:'.stripslashes($salesletternavbaralignment).';' : ""; ?>width:977px;}
...
<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Alert Bar")</script>' : ''; ?><?php echo '<div class="launchbanner_'.strtolower($postcustom['_launchpage_alertbarcolor'][0]).'">'.$postcustom['_launchpage_alertbartext'][0].'</div>'; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>
...
<div id="launchvideobox" style="width:<?php echo $launchvideocontainerwidth; ?>; height:<?php echo $launchvideocontainerheight; ?>;">
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_launchpage_videourl'])){
                   ...
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "349px";

                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "620px";
...
<?php (($postcustom['_launchpage_sidebarwidgettoshow'][0]!='0') && ($postcustom['_launchpage_sidebarwidgettoshow'][0]!='')) ? dynamic_sidebar( 'sidebar-'.$postcustom['_launchpage_sidebarwidgettoshow'][0] ) : ''; ?>
 ...
 <?php if($showcurrentsalespagetitletxt) : ?>
    <div class="launchsidebartitle">
    <?php echo ($currentsalespagetitletxt) ? $currentsalespagetitletxt : ''; ?>
    </div> 
<?php endif; ?>
