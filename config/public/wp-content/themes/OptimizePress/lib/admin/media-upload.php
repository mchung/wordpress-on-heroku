...
<?php 
$dir = dir(get_template_directory()."/images/cs");
...
<p class="page-heading">Coming Soon Image Setup</p>
...
<img src="<?php echo get_bloginfo('template_directory')."/images/cs/".$file; ?>" style="max-width:210px; max-height:140px;" /><br />
<input type="radio" name="cs_img" value="<?php echo get_bloginfo('template_directory')."/images/cs/".$file; ?>" /> <span class="page-txt"><?php echo $file; ?></span>
</div>
<?php	
if($row % 1) { 
?>
...
$optdircs = $myuploaddir['basedir']."/optpress/images_comingsoon"; 
...
while (($file = $dir->read()) !== false)
{
	...
	if ($file <> '.' && $file <> '..' && $file <> 'Thumbs.db' && $file <> 'index.php') {
		?>
<div style="width:250px; float:left;">
<img src="<?php echo $myuploaddir['baseurl']."/optpress/images_comingsoon/".$file; ?>" style="max-width:210px; max-height:140px;" /><br />
<input type="radio" name="cs_img" value="<?php echo $myuploaddir['baseurl']."/optpress/images_comingsoon/".$file; ?>" /> <span class="page-txt"><?php echo $file; ?></span>
</div>
<?php	
if($row % 1) { 
?>
...
$(document).ready(function() { 
	...
	$("#closelink").click(function() {
		$("#csimg", top.document).val($('input[name=cs_img]:checked').val());
	});
