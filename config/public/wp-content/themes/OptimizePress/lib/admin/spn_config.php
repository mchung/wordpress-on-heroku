...
$page_handle = $shortname . '-squeezeconfigs';
?>
<?php
/* The Options*/
$spn_options = array (
		...
		array(	"name" => "Nav Bar Alignment",
			"desc" => "",
			"id" => "squeezepagenavbaralignment",
			"type" => "navbaralign",
			"size" => "70"),

		array(	"name" => "Nav Bar Text",
			"desc" => "Text Color",
			"id" => "squeezepagenavbartextcolor",
			"type" => "color",
		...
		array(	"name" => "",
			...
			"id" => "squeezepagenavbartextshadow",
			"type" => "color",
		...
		array(	"name" => "",
			...
			"id" => "squeezepagenavbartexthovercolor",
			"type" => "color",
			...
			"id" => "squeezepagenavbartexthovercolorshadow",
			"type" => "color",
		...
		array(	"name" => "Nav Bar Sub-Menu Text",
			"desc" => "Text Color",
			"id" => "squeezepagenavbarsubtextcolor",
			"type" => "color",
			"default_value" => "ffffff",
			"size" => "70"),
		...
		array(	"name" => "",
			"desc" => "Text Color (Shadow)",
			"id" => "squeezepagenavbarsubtextshadow",
			"type" => "color",
		...
		array(	"name" => "Main Nav Bar Background",
			"desc" => "Top Color",
			"id" => "squeezepagenavbarmainbggradienttopcolor",
			"type" => "divcolor",
		...
		array(	"name" => "",
			"desc" => "Bottom Color",
			"id" => "squeezepagenavbarmainbggradientbotcolor",
			"type" => "divcolor",
		...
		array(	"name" => "Sub-Menu Background",
			"desc" => "Top Color",
			"id" => "squeezepagenavbarsubbggradienttopcolor",
			"type" => "divcolor",
		...
		array(	"name" => "",
			"desc" => "Bottom Color",
			"id" => "squeezepagenavbarsubbggradientbotcolor",
			"type" => "divcolor",
		...
		array(	"name" => "All Menus Background (Hover)",
			"desc" => "Top Color",
			"id" => "squeezepagenavbarmainbggradienthovertopcolor",
			"type" => "divcolor",
		...
		array(	"name" => "",
			"desc" => "Bottom Color",
			"id" => "squeezepagenavbarmainbggradienthoverbotcolor",
			"type" => "divcolor",
		...
		array(	"name" => "Nav Bar Bottom Line Color",
			"desc" => "",
			"id" => "squeezepagenavbarbottomlinecolor",
			"type" => "color",
			"default_value" => "333333",
			"size" => "70"),
...
<div class="admin-menu">
            ...
            <li class="selected1"><a href="admin.php?page=OptimizePress-squeezeconfigs">Squeeze Nav</a></li>
...
<span class="page-heading">Squeeze Page Navbar</span>
<div class="clear"></div>
</div>
<?php
...
if($_POST['updatesln']) {
	...
	if ( 'save' == $_REQUEST['action'] ) {		
		...
		foreach ($spn_options as $value) {		
			...
			update_option( $shortname.'_spn_settings', $options_array);
