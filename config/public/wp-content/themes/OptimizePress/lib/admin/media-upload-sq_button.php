...
<?php 
$dir = get_template_directory()."/images/optbuttons";
$newcsimg = $_REQUEST['newcsimg'];
$fldname = $_REQUEST['fld'];
$imgfldnum = $_REQUEST['imgfldnum'];
$imgpath = $_REQUEST['imgpath'];

if ($newcsimg == 1) {
$path = get_template_directory().'/images/optbuttons/';
...
?>
<div style="padding-left:15px; padding-right:15px; width:610px;">
...
<img src="<?php echo get_bloginfo('template_directory')."/images/optbuttons/".$file; ?>" style="max-width:210px; max-height:140px;" /><br />
<input type="radio" name="cs_img" value="<?php echo get_bloginfo('template_directory')."/images/optbuttons/".$file; ?>" /> <span class="page-txt"><?php echo $file; ?></span>
</div>
<?php	
if($row % 2) { 
?>
...
$optdircs = $myuploaddir['basedir']."/optpress/images_optbuttons"; 
...
while (($file = $dir->read()) !== false)
{
	...
	if ($file <> '.' && $file <> '..' && $file <> 'Thumbs.db' && $file <> 'index.php') {
		?>
<div style="width:250px; float:left;">
<img src="<?php echo $myuploaddir['baseurl']."/optpress/images_optbuttons/".$file; ?>" style="max-width:210px; max-height:140px;" /><br />
<input type="radio" name="cs_img" value="<?php echo $myuploaddir['baseurl']."/optpress/images_optbuttons/".$file; ?>" /> <span class="page-txt"><?php echo $file; ?></span>
</div>
<?php	
if($row % 1) { 
?>
...
$(document).ready(function() { 
	...
	$("#closelink").click(function() {
		$("#<?php echo $fldname;?>", top.document).val($('input[name=cs_img]:checked').val());
	});
