...
function optpress_black_arrow_list( $atts, $content = null ) {
	...
	$out .= str_replace('<ul>', '<ul class="black_arrow_list">', $content);
	$out .= '</div>';
...
function optpress_black_tick_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="black_tick_list">', $content);
	$out .= '</div>';
...
function optpress_red_arrow_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="red_arrow_list">', $content);
	$out .= '</div>';
...
function optpress_red_tick_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="red_tick_list">', $content);
	$out .= '</div>';
...
function optpress_green_plus_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="green_plus_list">', $content);
	$out .= '</div>';
...
function optpress_green_plus_2_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="green_plus_2_list">', $content);
	$out .= '</div>';
...
function optpress_green_tick_1_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="green_tick_1_list">', $content);
	$out .= '</div>';
...
function optpress_green_tick_2_list( $atts, $content = null ) {
	...
	$out .= '<div style="width:' .$width. ';margin:0px auto;">';
	$out .= str_replace('<ul>', '<ul class="green_tick_2_list">', $content);
	$out .= '</div>';
...
function optpress_risk_free_order_box_2( $atts, $content = null ) {
	...
	$out .= '<div class="orderboxbk">' .$content.'</div>';
	$out .= '<div class="orderboxbtm"></div>';
...
function optpress_membership_download_item_excel( $atts, $content = null ) {
	extract(shortcode_atts(array(
		'link'      => '#',
		'target'	=> '_self',
    ), $atts));
...
add_shortcode('membership_download_item_excel', 'optpress_membership_download_item_excel');



function optpress_membership_download_item_ppt( $atts, $content = null ) {
	extract(shortcode_atts(array(
		'link'      => '#',
		'target'	=> '_self',
    ), $atts));
...
add_shortcode('membership_download_item_ppt', 'optpress_membership_download_item_ppt');
...
function optpress_new_video_with_placeholder( $atts, $content = null ) {
	extract(shortcode_atts(array(
		'video_url'     => 'http://www.videourl.com',
		'width'			=> '500',
		'height'		=> '300',
...
add_shortcode('new_video_with_placeholder', 'optpress_new_video_with_placeholder');

function optpress_new_video_with_autoplay( $atts, $content = null ) {
	extract(shortcode_atts(array(
		'video_url'     => 'http://www.videourl.com',
		'width'			=> '500',
		'height'		=> '300',
...
add_shortcode('new_video_with_autoplay', 'optpress_new_video_with_autoplay');
...
<iframe src="http://www.facebook.com/plugins/like.php?href='.get_permalink().'&amp;layout=box_count&amp;show_faces=false&amp;width=70&amp;action=like&amp;font=lucida+grande&amp;colorscheme=light&amp;height=62" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:70px; height:62px;" allowTransparency="true"></iframe><span style="height:20px;width:77px;vertical-align:top;padding-bottom:1px;display: inline-block;text-align:left;"><a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></span><span style="height:62px;width:65px;vertical-align:top;display: inline-block;text-align:left;"><a name="fb_share" share_url="' .get_permalink($postcustom['_launchpage_page2share'][0]). '" type="box_count"></a></span></div>';
$out .= $content;
...
function optpress_sharebox4( $atts, $content = null ) {
	extract(shortcode_atts(array(
	'sharetext'     => 'Share This Page',
	), $atts));
...
add_shortcode('sharebox4', 'optpress_sharebox4');





function optpress_sharebox5_no_text( $atts, $content = null ) {
	extract(shortcode_atts(array(
	), $atts));
...
add_shortcode('sharebox5_no_text', 'optpress_sharebox5_no_text');



function optpress_sharebox5_no_border( $atts, $content = null ) {
	extract(shortcode_atts(array(
	), $atts));
...
add_shortcode('sharebox5_no_border', 'optpress_sharebox5_no_border');



function optpress_google_website_optimizer( $atts, $content = null ) {
	extract(shortcode_atts(array(
...
add_shortcode('google_website_optimizer', 'optpress_google_website_optimizer');

//************************************* Delay Content
function optpress_delay_content( $atts, $content = null ) {
	extract(shortcode_atts(array(
        'id'      => 'unique',
        'delay'      => '5',
    ), $atts));
...
add_shortcode('delay_content', 'optpress_delay_content');

//************************************* Two Column Div Content
function optpress_two_columns( $atts, $content = null ) {
}
add_shortcode('two_columns', 'optpress_two_columns');

function optpress_two_columns_1( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box1_2column">';
	$out .= $content;
	$out .= '</div>';

   return $out;
}
add_shortcode('two_columns_1', 'optpress_two_columns_1');

function optpress_two_columns_2( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box2_2column">';
	$out .= $content;
	$out .= '</div>';
...
add_shortcode('two_columns_2', 'optpress_two_columns_2');


//************************************* Three Column Div Content
function optpress_three_columns( $atts, $content = null ) {
}
add_shortcode('three_columns', 'optpress_three_columns');

function optpress_three_columns_1( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box1_3column">';
	$out .= $content;
	$out .= '</div>';

   return $out;
}
add_shortcode('three_columns_1', 'optpress_three_columns_1');

function optpress_three_columns_2( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box2_3column">';
	$out .= $content;
	$out .= '</div>';

   return $out;
}
add_shortcode('three_columns_2', 'optpress_three_columns_2');

function optpress_three_columns_3( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box3_3column">';
	$out .= $content;
	$out .= '</div>';
	$out .= '<div style="clear:both;"></div>';
...
add_shortcode('three_columns_3', 'optpress_three_columns_3');



//************************************* Four Column Div Content
function optpress_four_columns( $atts, $content = null ) {
}
add_shortcode('four_columns', 'optpress_four_columns');

function optpress_four_columns_1( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box1_4column">';
	$out .= $content;
	$out .= '</div>';
	
   return $out;
}
add_shortcode('four_columns_1', 'optpress_four_columns_1');

function optpress_four_columns_2( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box2_4column">';
	$out .= $content;
	$out .= '</div>';
	
   return $out;
}
add_shortcode('four_columns_2', 'optpress_four_columns_2');

function optpress_four_columns_3( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box3_4column">';
	$out .= $content;
	$out .= '</div>';
	
   return $out;
}
add_shortcode('four_columns_3', 'optpress_four_columns_3');

function optpress_four_columns_4( $atts, $content = null ) {
	$content = do_shortcode( shortcode_unautop( $content ) );
	if ( '</p>' == substr( $content, 0, 4 )
	and '<p>' == substr( $content, strlen( $content ) - 3 ) )
	$content = substr( $content, 4, strlen( $content ) - 7 );
	
	$out .= '<div class="box4_4column">';
	$out .= $content;
	$out .= '</div>';
	$out .= '<div style="clear:both;"></div>';
...
add_shortcode('four_columns_4', 'optpress_four_columns_4');





function optpress_small_text( $atts, $content = null ) {
	extract(shortcode_atts(array(
        'color'      => '',
    ), $atts));
	...
	$out .= '<p style="font-size:13px !important;line-height:20px;padding-bottom:0px;">';
	$out .= $content;
	$out .= '</p>';
	
   return $out;
}
add_shortcode('small_text', 'optpress_small_text');
