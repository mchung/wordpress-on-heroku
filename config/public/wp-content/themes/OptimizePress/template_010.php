...
<div class="ecoversection">
<?php $url = get_bloginfo('template_directory'); ?>

<div class="ecoverbox">
<?php if($postcustom['_optthemes_activateecover']) { // Ecover ?>
<?php echo ($postcustom['_optthemes_ecoverimageurl']) ? '<center><img src="'.$postcustom['_optthemes_ecoverimageurl'][0].'" border="0" OnClick="show_alert()" style="cursor:pointer;"></center>' : ''; ?>
<?php } ?>
</div>

<?php if($postcustom['_optthemes_showpdficont10']) { ?>
<div class="pdficon"><img src="<?php echo $url?>/images/template010-pdficon.png" width="118" height="223" <?php echo ($postcustom['_optthemes_js1message']) ? ' OnClick="show_alert()"' : ''; ?> style="cursor:pointer;"  /></div>
<?php } ?>
...
<?php if(!$postcustom['_optthemes_hidedlbutton10']) { ?>
<center><img src="<?php echo $url?>/images/template010-downloadbutton.png" width="333" height="92" <?php echo ($postcustom['_optthemes_js1message']) ? ' OnClick="show_alert()"' : ''; ?> style="cursor:pointer;" /></center>
<?php } ?>
</div><!--close left1-->


<div class="largearrow"><img src="<?php echo $url?>/images/arrows-animated.gif" width="211" height="421" />
