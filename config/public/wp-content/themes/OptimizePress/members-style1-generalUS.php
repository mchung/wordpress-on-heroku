...
<?php /*
Template Name: Members 1 General Page (Free/DAP/WL)
*/
?>
...
<?php   if($post->post_parent)
  $children = wp_list_pages("title_li=&child_of=".$post->post_parent."&echo=0&depth=1"); // Nick 11/19/2010
  else
  $children = wp_list_pages("title_li=&child_of=".$post->ID."&echo=0&depth=1"); // Nick 11/19/2010
  if ($children) { ?>
