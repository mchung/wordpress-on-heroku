...
<?php /*
Template Name: Wide Sales Style 1 (Sales Letter Standard)
*/
?>
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_launchpage_videourl'])){
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "540px";
                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "960px";
...
<div id='mediaspace'><center>Your browser does not support Flash or does not have it installed. <a href="http://http://www.adobe.com/products/flashplayer/" target="_blank">Click here download Flash Now</a></center></div>
