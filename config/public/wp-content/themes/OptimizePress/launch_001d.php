...
<?php /*
Template Name: Sales Style 1 (Sales Letter Standard)
*/
?>
...
<center><input class="button1" id="submit_image_5f17aab77d6c" type="image" src="<?php echo stripcslashes($postcustom['_launchpage_optinbutton'][0]); ?>" name="submit" value=""/></center>
...
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<?php echo $thesharelink; ?>" send="true" show_faces="true" width="850" font=""></fb:like>
<div id="fb-root" style="padding-top:8px;"></div>
<script>(function(d, s, id) {
  var js, fjs = d.getElementsByTagName(s)[0];
  if (d.getElementById(id)) return;
...
foreach ($loadfontsarray as $key => $value) {
	echo ($postcustom['_launchpage_preheadlinefont'][0]==$key || $postcustom['_launchpage_subheadlinefont'][0]==$key || $postcustom['_launchpage_headlineabovevideofont'][0]==$key || $postcustom['_launchpage_headlinebelowvideofont'][0]==$key || $postcustom['_launchpage_headertextfont'][0]==$key || $postcustom['_launchpage_subheadcufonfont'][0]==$key) ? '<script type="text/javascript" src="'.$templatedir.'/js/fonts/'.$value.'.js"></script>' : '';
	$value = $value * 2;
}
