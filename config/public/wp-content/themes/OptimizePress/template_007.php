...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_optthemes_videoembedcode'])){
                   ...
                   $videowidth = !empty($postcustom['_optthemes_videowidth']) ? stripcslashes($postcustom['_optthemes_videowidth'][0])."px" :  "605px";
    ...
    <?php $autoplay = !empty($postcustom['_optthemes_autoplay']) ? "true" :  "false"; ?>
     ...
     <style>#videocontainer{width:<?php echo $videowidth?>;height:<?php echo $videoheight?>;margin:0px auto;}
...
<div class="aclear" style="width:1038px;"></div>

<div style="width:1000px;height:20px;"></div>


</div><!--close maingradient-->

<div id="main-lower"><!--close videocontainer-->
