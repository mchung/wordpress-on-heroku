...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_optthemes_videoembedcode'])){
                   $videoheight = !empty($postcustom['_optthemes_videoheight']) ? stripcslashes($postcustom['_optthemes_videoheight'][0])."px" :  "315px";
...
<?php echo !empty($postcustom['_optthemes_headlinebelowvideo']) ? '<h3 class="main-bottomheadline">'.stripcslashes($postcustom['_optthemes_headlinebelowvideo'][0]).'</h3>' :  ""; ?>
...
<?php if($postcustom['_optthemes_activedoubleoptin']) { // Nick 11/19/2010 ?>
