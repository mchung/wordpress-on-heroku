...
<?php /*
Template Name: Members 1 Content (Free/DAP/WL)
*/
?>
...
?>
<?php // If CHILD_OF is not NULL, then this page has a parent
// Therefore, list siblings i.e. subpages of this page's parent
if($post->post_parent){
	add_filter( 'wp_list_pages', 'backto_nav_menu_items' ); // Nick 11/19/2010
...
<div class="moduletitle"><?php $parent_title = get_the_title($post->post_parent);
echo $parent_title;
?></div>

<div class="contenttitle1"><?php wp_title(' '); ?></div>
