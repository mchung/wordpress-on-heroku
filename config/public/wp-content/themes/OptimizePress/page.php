...
($postcustom['_launchpage_disablecookiecheck']) ? include 'inc_check_user_cookie.php' : ''; // Enable/Disable Cookie Check
...
#membersnavbar{<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px' : ""; ?>}
...
<!-- Headlines -->
<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Sales-PreHeadline")</script>' : ''; ?><?php echo !empty($postcustom['_launchpage_preheadline']) ? '<h2 class="sales-preheadline">'.stripcslashes($postcustom['_launchpage_preheadline'][0]).'</h2>' :  ""; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>

<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Sales-TopHeadline")</script>' : ''; ?><?php echo ($postcustom['_launchpage_headlineabovevideotext']) ? '<h1 class="launchtopheadline">'.$postcustom['_launchpage_headlineabovevideotext'][0].'</h1>' : ''; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>

<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Sales-PostHeadline")</script>' : ''; ?><?php echo !empty($postcustom['_launchpage_subheadline']) ? '<h2 class="sales-postheadline">'. stripcslashes($postcustom['_launchpage_subheadline'][0]) .'</h2>' :  ""; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>
...
<div id='mediaspace'><center>Your browser does not support Flash or does not have it installed. <a href="www.adobe.com/products/flashplayer/" target="_blank">Click here download Flash Now</a></center></div>
...
<div id="launchcta" class="launchcta" <?php echo ($postcustom['_launchpage_activatedelaybutton']) ? 'style="display: none;"' : ''; ?>> 
    <div id="ctastyle" style="height:162px;width:393px;margin:0px auto;background:transparent url(<?php echo $templatedir; ?>/images/ctabuttons/style/<?php echo stripcslashes($postcustom['_launchpage_calltoactionbuttonstyle'][0]); ?>.png) no-repeat scroll 0 0;">
        <a <?php echo ($postcustom['_launchpage_ctalinkstarget'][0]) ? 'target="_blank"' : ''; ?> href="<?php echo $postcustom['_launchpage_calltoactionurl'][0]; ?>">
...
<center><input class="button1" id="submit_image_5f17aab77d6c" type="image" src="<?php echo $templatedir; ?>/images/<?php echo stripcslashes($postcustom['_launchpage_optinbutton'][0]); ?>" name="submit" value=""/></center>

<?php echo !empty($postcustom['_launchpage_spamnoticetext1']) ? '<div class="sidebar-padlock">'.stripcslashes($postcustom['_optthemes_spamnoticetext'][0]).'</div>' :  ""; ?>
...
<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Sales-HeadlineUnderVideo")</script>' : ''; ?><?php echo ($postcustom['_launchpage_headlinebelowvideotext']) ? '<h1 class="launchbottomheadline">'.$postcustom['_launchpage_headlinebelowvideotext'][0].'</h1>' : ''; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>
...
?>
<div id="delayedcontent" class="delaycontentbox" <?php echo ($postcustom['_launchpage_activatedelaycontentbox']) ? 'style="display: none;"' : ''; ?>>
	<?php echo ($postcustom['_launchpage_delaycontentboxtext']) ? stripslashes($postcustom['_launchpage_delaycontentboxtext'][0]) : ''; ?>
</div>
...
<?php echo !empty($postcustom['_launchpage_webformhiddenhtml']) ? stripcslashes(eval('?>'.htmlspecialchars_decode($postcustom['_launchpage_webformhiddenhtml'][0]))) : ""; ?>
<center><input class="button1" id="submit_image_5f17aab77d6c" type="image" width="268" src="<?php echo $templatedir; ?>/images/<?php echo stripcslashes($postcustom['_launchpage_optinbutton'][0]); ?>" name="submit" value=""/></center>
...
<?php comments_template(); // Get wp-comments.php template ?>
        ...
        case "Facebook" : { ?>
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<?php echo $thesharelink; ?>" show_faces="true" send="true" width="600" font=""></fb:like>
...
<div class="fb-comments" data-href="<?php echo $thesharelink; ?>" data-num-posts="<?php echo ($postcustom['_launchpage_fbcommentnum']) ? $postcustom['_launchpage_fbcommentnum'][0] : '20'; ?>" data-width="600" publish_feed="true"></div>
