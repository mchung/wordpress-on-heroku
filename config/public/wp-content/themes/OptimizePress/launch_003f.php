...
<?php /*
Template Name: Sales Style 3 (Squeeze Style) 
*/
?>
...
<div id="launchnavbar"><?php include ("inc_pages_links.php");?></div>
...
<div style="float:left;width:550px;padding-left:40px;">



<?php 
   $launchvideocontainerheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "309px";

   $launchvideocontainerwidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "550px";
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_launchpage_videourl'])){
                   ...
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "309px";

                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "550px";
