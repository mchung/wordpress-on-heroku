...
<?php /*
Template Name: Thin Sales Style 1 (Sales Letter Standard)
*/
?>
...
#membersnavbar{<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px;' : ""; ?><?php echo ($salesletternavbaralignment) ? 'text-align:'.stripslashes($salesletternavbaralignment).';' : ""; ?>width:836px !important;;}
...
<?php if($postcustom['_launchpage_showheader']) { ?>
	...
	.launchheaderlogo{background-position:<?php echo $logo_align; ?> center;background-image:url(<?php echo $launchheaderlogo; ?>);<?php echo ($header_height) ? "height:".$header_height."px" : ""; ?>;width:836px;background-repeat:no-repeat;}
#headertext{<?php echo ($header_height) ? "line-height:".$header_height."px" : ""; ?>;text-align:center;width:836px;<?php echo ($header_height) ? "height:".$header_height."px" : ""; ?>;font-size:<?php echo ($postcustom['_launchpage_headertextsize']) ? $postcustom['_launchpage_headertextsize'][0].'px' : '48px'; ?>;letter-spacing:-2px;font-weight:normal;}
    </style>
...
<?php } else { ?>
            ...
            <?php if(!empty($postcustom['_launchpage_videourl'])){
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "409px";
                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "727px";
...
<?php comments_template(); // Get wp-comments.php template ?>
        ...
        case "Facebook" : { ?>
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<?php echo $thesharelink; ?>" show_faces="true" send="true" width="720" font=""></fb:like>
...
<div class="fb-comments" data-href="<?php echo $thesharelink; ?>" data-num-posts="<?php echo ($postcustom['_launchpage_fbcommentnum']) ? $postcustom['_launchpage_fbcommentnum'][0] : '20'; ?>" data-width="720" publish_feed="true"></div>
</div>
