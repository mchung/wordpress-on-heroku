...
<?php /*
Template Name: Sales Style 6 (OptimizePressPro)
*/
?>
...
#membersnavbar{<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px' : ""; ?>;<?php echo ($salesletternavbaralignment) ? 'text-align:'.stripslashes($salesletternavbaralignment).';' : ""; ?>}
#membersnavbarbk{
background: #<?php echo ($salesletternavbarmainbggradienttopcolor) ? $salesletternavbarmainbggradienttopcolor : ""; ?>;
background-image: -moz-linear-gradient(100% 100% 90deg, #<?php echo ($salesletternavbarmainbggradientbotcolor) ? $salesletternavbarmainbggradientbotcolor : ""; ?>, #<?php echo ($salesletternavbarmainbggradienttopcolor) ? $salesletternavbarmainbggradienttopcolor : ""; ?>);
background-image: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#<?php echo ($salesletternavbarmainbggradienttopcolor) ? $salesletternavbarmainbggradienttopcolor : ""; ?>), to(#<?php echo ($salesletternavbarmainbggradientbotcolor) ? $salesletternavbarmainbggradientbotcolor : ""; ?>));
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#<?php echo ($salesletternavbarmainbggradienttopcolor) ? $salesletternavbarmainbggradienttopcolor : ""; ?>, endColorstr=#<?php echo ($salesletternavbarmainbggradientbotcolor) ? $salesletternavbarmainbggradientbotcolor : ""; ?>);
...
border-bottom:<?php echo ($salesletternavbarbottomlinethickness) ? $salesletternavbarbottomlinethickness : ""; ?>px solid #<?php echo ($salesletternavbarbottomlinecolor) ? $salesletternavbarbottomlinecolor : ""; ?>;<?php echo ($salesletterpagenavbarheight) ? 'height:'.$salesletterpagenavbarheight.'px' : ""; ?>;
}

#access a {color:#<?php echo ($salesletternavbartextcolor) ? $salesletternavbartextcolor : ""; ?>;text-shadow:0 1px 0 #<?php echo ($salesletternavbartextshadow) ? $salesletternavbartextshadow : ""; ?>;<?php echo ($salesletterpagenavbarfontw8) ? 'font-weight:'.$salesletterpagenavbarfontw8 : ""; ?>;<?php echo ($salesletterpagenavbarheight) ? 'line-height:'.$salesletterpagenavbarheight.'px' : ""; ?>}
...
background-image: -moz-linear-gradient(100% 100% 90deg, #<?php echo ($salesletternavbarmainbggradienthoverbotcolor) ? $salesletternavbarmainbggradienthoverbotcolor : ""; ?>, #<?php echo ($salesletternavbarmainbggradienthovertopcolor) ? $salesletternavbarmainbggradienthovertopcolor : ""; ?>);
background-image: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#<?php echo ($salesletternavbarmainbggradienthovertopcolor) ? $salesletternavbarmainbggradienthovertopcolor : ""; ?>), to(#<?php echo ($salesletternavbarmainbggradienthoverbotcolor) ? $salesletternavbarmainbggradienthoverbotcolor : ""; ?>));
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#<?php echo ($salesletternavbarmainbggradienthovertopcolor) ? $salesletternavbarmainbggradienthovertopcolor : ""; ?>, endColorstr=#<?php echo ($salesletternavbarmainbggradienthoverbotcolor) ? $salesletternavbarmainbggradienthoverbotcolor : ""; ?>);
...
font-size:<?php echo ($salesletternavbarfontsize) ? $salesletternavbarfontsize : ""; ?>px;
}
...
background-image: -moz-linear-gradient(100% 100% 90deg, #<?php echo ($salesletternavbarsubbggradientbotcolor) ? $salesletternavbarsubbggradientbotcolor : ""; ?>, #<?php echo ($salesletternavbarsubbggradienttopcolor) ? $salesletternavbarsubbggradienttopcolor : ""; ?>);
background-image: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#<?php echo ($salesletternavbarsubbggradienttopcolor) ? $salesletternavbarsubbggradienttopcolor : ""; ?>), to(#<?php echo ($salesletternavbarsubbggradientbotcolor) ? $salesletternavbarsubbggradientbotcolor : ""; ?>));
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#<?php echo ($salesletternavbarsubbggradienttopcolor) ? $salesletternavbarsubbggradienttopcolor : ""; ?>, endColorstr=#<?php echo ($salesletternavbarsubbggradientbotcolor) ? $salesletternavbarsubbggradientbotcolor : ""; ?>);
...
#access ul ul{<?php echo ($salesletterpagenavbarheight) ? 'top:'.$salesletterpagenavbarheight.'px' : ""; ?>}

#access .menu-header, div.menu{font-size:<?php echo ($salesletternavbarfontsize) ? $salesletternavbarfontsize : ""; ?>px}
...
#access .menu-header li, div.menu li{font-size:<?php echo ($salesletternavbarfontsize) ? $salesletternavbarfontsize : ""; ?>px;}

#launchbk p{font-size:14px;}

#launchbk h2{font-size:24px;line-height:28px;}

#launchbk h3{font-size:14px;font-weight:bold;margin-bottom:2px;margin-top:20px;letter-spacing:0px;}

#launchbk p.smalltext{font-size:12px;line-height:20px;color:#333333;}

#launchbk p.largetext{font-size:31px;line-height:33px;color:#000000;font-weight:normal;text-align:center;}

#launchbk p.largetext2{font-size:31px;line-height:33px;color:#000000;font-weight:normal;text-align:center;}

.dividerline{width:840px;padding-top:10px;padding-bottom:10px;border-top:1px solid #e5e5e5;margin-top:30px;margin-bottom:15px;}
.dividerline2{width:840px;padding-top:10px;padding-bottom:10px;border-top:1px solid #e5e5e5;margin-top:15px;margin-bottom:15px;}

.box1{float:left;width:245px;padding-right:45px;} 

.box2{float:left;width:245px;padding-right:45px;}

.box3{float:left;width:250px;}

.boxnew1{float:left;width:375px;padding-right:85px;} 

.boxnew2{float:left;width:375px;}

.aclear{clear:both}

.green_plus_list li {font-size:14px;}
</style>
...
<div style="height:auto;padding-bottom:15px;padding-top:15px;">
...
<?php } else { ?>
            ...
            <?php  if(!empty($postcustom['_launchpage_videourl'])){
                   $videoheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "506px";
                   $videowidth = !empty($postcustom['_launchpage_videowidth']) ? stripcslashes($postcustom['_launchpage_videowidth'][0])."px" :  "900px";
            ...
            ?>
                       ...
                       <?php $autoplay = !empty($postcustom['_launchpage_autoplay']) ? "true" :  "false"; ?><!-- This is the Player Codes -->

 <style>#launchvideobox{height:<?php echo $videoheight?>;width:<?php echo $videowidth?>;}
 #videobox{height:<?php echo $videoheight?>;width:<?php echo $videowidth?>;}</style>
...
<div id="videodownloadlink"><a href="<?php echo $postcustom['_launchpage_downloadvideourl'][0]; ?>"><?php echo $postcustom['_launchpage_videodownloadlinktext'][0]; ?></a></div>
...
<div style="width:818px;height:33px;background-image:url(<?php echo $templatedir; ?>/images/newtemplate-shadow.png);margin:0px auto;"></div>
...
<div id="launchcta" class="launchcta" <?php echo ($postcustom['_launchpage_activatedelaybutton']) ? 'style="display: none;"' : ''; ?>> 
    <div id="ctastyle" style="height:162px;width:393px;margin:0px auto;background:transparent url(<?php echo $templatedir; ?>/images/ctabuttons/style/<?php echo stripcslashes($postcustom['_launchpage_calltoactionbuttonstyle'][0]); ?>.png) no-repeat scroll 0 0;">
        <a href="<?php echo $postcustom['_launchpage_calltoactionurl'][0]; ?>">
            <img src="<?php echo $templatedir; ?>/images/ctabuttons/<?php echo stripcslashes($postcustom['_launchpage_calltoactionbutton'][0]); ?>.png" border="0" style="padding-top:8px;" />
        </a>
    </div><!--close ctastyle-->
</div><!--close launchcta-->
...
<?php echo nl2br($postcustom['_launchpage_contentblockabovevideo'][0]); ?>
<?php echo '<div class="launchbanner_'.strtolower($postcustom['_launchpage_alertbarcolor'][0]).'">'.$postcustom['_launchpage_alertbartext'][0].'</div>'; ?>
</div>
<?php } else if($postcustom['_launchpage_contentblockabovevideo']) { ?>
<div id="launchinnertop">
<?php echo nl2br($postcustom['_launchpage_contentblockabovevideo'][0]); // adds nl2br( ) to make the line breaks display as is ?>
</div>
...
<?php $thesharelink = get_permalink($postcustom['_launchpage_page2share'][0]); ?>
...
<div id="sharebarnew-twitter"><?php echo ($postcustom['_launchpage_twitterurl']) ? '<a target="_blank" href="http://twitter.com/home?status='.$postcustom['_launchpage_twitterurl'][0].' '.$thesharelink.'"><img src="'.$templatedir.'/images/'.$postcustom['_launchpage_socialmeduabutton'][0].'twittersmall.png" border="0" /></a>' : ''; ?></div>
...
<!-- Headlines -->
<?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '<script>utmx_section("Pre-Headline")</script>' : ''; ?><?php echo !empty($postcustom['_launchpage_preheadline']) ? '<h2 class="sales-preheadline">'.stripcslashes($postcustom['_launchpage_preheadline'][0]).'</h2>' :  ""; ?><?php echo !empty($postcustom['_seo_activategoogleweboptimizermv']) ? '</noscript>' : ''; ?>
...
<?php  echo !empty($postcustom['_launchpage_webformhiddenhtml']) ? stripcslashes($postcustom['_launchpage_webformhiddenhtml'][0]) : ""; ?>
<center><input class="button1" id="submit_image_5f17aab77d6c" type="image" src="<?php echo $templatedir; ?>/images/<?php echo stripcslashes($postcustom['_launchpage_optinbutton'][0]); ?>.png" name="submit" value=""/></center>
...
<div class="commenticon"></div><div class="commenttitle"><h2><?php echo ($postcustom['_launchpage_wpcommentstitle']) ? $postcustom['_launchpage_wpcommentstitle'][0] : 'Leave A Reply'; // nick 11/01/2010 ?> (<?php comments_number('No comments', 'One comment', '% comments'); ?>    So Far)</h2></div><div class="aclear"></div>
...
<script>
  window.fbAsyncInit = function() {
    FB.init({appId: '<?php echo ($postcustom['_launchpage_facebookapikey']) ? $postcustom['_launchpage_facebookapikey'][0] : ""; ?>', status: true, cookie: true,
             xfbml: true});
  };
  (function() {
...
<fb:comments numposts="20"></fb:comments>
...
<?php // nick 11/01/2010 ?>
<?php if($postcustom['_launchpage_activatesidebarblock']) { ?>
	<?php if ( is_active_sidebar( 'sidebar-'.$postcustom['_launchpage_sidebarwidgettoshow'][0] ) ) : ?>
		<?php (($postcustom['_launchpage_sidebarwidgettoshow'][0]!='0') && ($postcustom['_launchpage_sidebarwidgettoshow'][0]!='')) ? dynamic_sidebar( 'sidebar-'.$postcustom['_launchpage_sidebarwidgettoshow'][0] ) : ''; ?>
	<?php endif; ?>
<?php } ?>
<?php if($postcustom['_launchpage_showsidebarlinksthumbnails']) { ?>
<ul class="launch1sidebar">
<?php echo $activelinks_vid.$inactivelinks_vid; ?>
</ul>
<?php } ?>
</div>
...
<div class="footer-left">&copy;
	<?php echo ($footer_text) ? $footer_text : ""; ?>
...
echo ($customtrackingcodefooter) ? stripslashes($customtrackingcodefooter) : ""; ?>
<?php echo ($postcustom['_seo_footertrackingjscode']) ? stripslashes($postcustom['_seo_footertrackingjscode'][0]) : ""; ?>
