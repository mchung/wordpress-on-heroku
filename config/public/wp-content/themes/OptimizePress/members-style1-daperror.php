...
<?php /*
Template Name: Members 1 DAP/Wishlist Error
*/
?>
...
<img src="<?php echo get_bloginfo('template_directory'); ?>/images/daperror.png" align="right" border="0" style="padding-bottom:15px;padding-left:10px;">
</div>
...
<div class="memberstitle1">Sorry! You do not have access to this content</div>
