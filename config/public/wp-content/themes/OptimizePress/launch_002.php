...
<?php /*
Template Name: Sales Style 2 (Video Sidebar Bottom)
*/
?>
...
<?php comments_template(); // Get wp-comments.php template ?>
        ...
        case "Facebook" : { ?>
<div id="fbcomments">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="" show_faces="true" send="true" width="600" font=""></fb:like>
