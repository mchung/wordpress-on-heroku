...
<center><input class="button1" id="submit" type="image" src="<?php echo stripcslashes($postcustom['_optthemes_buttonselect'][0]); ?>" name="submit" value="Get Instant Access"/></center>
 ...
 <?php echo !empty($postcustom['_optthemes_spamnoticetext']) ? '<p align="center" style="line-height:14px;font-size:11px;width:300px;color:#555555;padding-top:10px;margin:0px auto;">'.stripcslashes($postcustom['_optthemes_spamnoticetext'][0]).'<br /><br /><br /><br /></p>' :  ""; ?>
