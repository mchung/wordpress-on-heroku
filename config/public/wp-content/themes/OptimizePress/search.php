...
?>
		...
		#headertext{<?php echo ($blogheaderheight) ? "line-height:".$blogheaderheight."px" : ""; ?>;text-align:center;width:977px;<?php echo ($blogheaderheight) ? "height:".$blogheaderheight."px" : ""; ?>;letter-spacing:-2px;font-weight:normal;}
...
<?php while (have_posts()) : the_post(); ?>
    ...
    <p><?php                    ob_start();
                   ...
                   $postOutput = strip_tags($postOutput);
                   ob_end_clean();
                   echo substr($postOutput, 0, 220);
                ?>... </p>
...
<?php if(!$blogdisablecommentstats) { // if Comment Stats is disabled ?>
    ...
    <div class="commentslink"><a href="<?php the_permalink(); ?>"><?php comments_number('No comments','1 comment','% comments'); ?></a></div>
<?php } ?>
