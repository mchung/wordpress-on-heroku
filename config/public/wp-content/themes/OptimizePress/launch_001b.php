...
<?php /*
Template Name: Sales Style 1 (Video Sidebar Top) 
*/
?>
...
#access ul li.current-menu-item > a {font-size:<?php echo ($salesletternavbarfontsize) ? $salesletternavbarfontsize : ""; ?>px;
	padding:0 15px;}
