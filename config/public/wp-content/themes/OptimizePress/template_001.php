...
<style>body{font-family:<?php echo $mainbodytextfont?>;background: #e7e7e7 url(<?php echo $url?>/images/style1a-mainbg.png);background-repeat:repeat-x;}
...
alert(msg);
    ...
    <?php $autoplay = !empty($postcustom['_optthemes_autoplay']) ? "true" :  "false"; ?>
     ...
     <style>body{background: #e7e7e7 url(<?php echo $url?>/images/style1a-mainbg.png);background-repeat:repeat-x;}</style>
...
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="" show_faces="true" send="true" width="560" font=""></fb:like>
