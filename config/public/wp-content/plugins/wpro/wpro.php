...
class WordpressReadOnlyS3 extends WordpressReadOnlyBackend {
	...
	function __construct() {
		...
		// // Read from env.
		// if (isset($_SERVER["AWS_ACCESS_KEY"])) {
		// 	$this->key = $_SERVER["AWS_ACCESS_KEY"];
		// }
		// if (isset($_SERVER["AWS_SECRET_KEY"])) {
		// 	$this->secret = $_SERVER["AWS_SECRET_KEY"];
		// }
		// if (isset($_SERVER["AWS_WP_BUCKET"])) {
		// 	$this->bucket = $_SERVER["AWS_WP_BUCKET"];
		// }
		// if (isset($_SERVER["AWS_ENDPOINT"])) {
		// 	$this->endpoint = $_SERVER["AWS_ENDPOINT"];
		// }
	}
...
class WordpressReadOnly extends WordpressReadOnlyGeneric {
	...
	public $backend = null;
	public $tempdir = '/app/client_body_temp';
